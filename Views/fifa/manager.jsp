...
<div class="ui grid">
	<div class="ui five wide column card">
		<img class="ui rounded fluid image" src="${path}/image.ll?role=Manager&img=profile&name=${info.name}">
	...
	<div class="ui eleven wide column container">
		...
		<div class="ui grid">
			...
			<div class="ui eight wide column">
				...
				<div class="ui field">
					<div class="ui labeled input">
						<label class="ui basic label llab f k r" for="tactic">tactic</label>
						<input type="text" name="tactic" id="tactic" value="${info.tactic}" readonly>
					</div>
				</div>
			</div>
		</div>
